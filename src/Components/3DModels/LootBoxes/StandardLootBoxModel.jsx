...
export const StandardLootBoxModel = forwardRef((props, ref) => {
  const { scene, animations } = useGLTF("/3d/lootboxes/standard/scene.gltf");
...
useGLTF.preload("/3d/lootboxes/standard/scene.gltf");
