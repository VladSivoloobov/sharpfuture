...
export const IronLootBoxModel = forwardRef((props, ref) => {
  const { scene, animations } = useGLTF("/3d/lootboxes/iron/scene.gltf");
...
useGLTF.preload("/3d/lootboxes/iron/scene.gltf");
