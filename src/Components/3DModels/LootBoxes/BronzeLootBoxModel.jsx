...
export const BronzeLootBoxModel = forwardRef((props, ref) => {
  const { scene, animations } = useGLTF("/3d/lootboxes/bronze/scene.gltf");
  ...
  return (
    <group
      onAfterRender={() => props.handleRendering(true)}
      ref={ref}
      {...props}
      dispose={null}
    >
...
useGLTF.preload("/3d/lootboxes/bronze/scene.gltf");
