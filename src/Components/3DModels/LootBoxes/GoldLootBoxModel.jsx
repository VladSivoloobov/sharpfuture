...
export const GoldLootBoxModel = forwardRef((props, ref) => {
  const { scene, animations } = useGLTF("/3d/lootboxes/gold/scene.gltf");
...
useGLTF.preload("/3d/lootboxes/gold/scene.gltf");
